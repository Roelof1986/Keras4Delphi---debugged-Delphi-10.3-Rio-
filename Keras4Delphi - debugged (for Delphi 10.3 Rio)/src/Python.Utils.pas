...
type
 ...
 TPythonObject = class
   ...
   public
     ...
     function ToDoubleArray: {TArray<Double>}Variant;
...
function TPythonObject.ToDoubleArray: {TArray<Double>}Variant;
begin
    Result := g_MyPyEngine.PyObjectAsDoubleArray(FHandle);
end; // added
...
begin
    inherited create;
    FHandle := g_MyPyEngine.{PyInt}PyLong_FromLong(value);    // note : only 32 bit integers!
end;
